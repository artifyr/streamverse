...
const PopularMovies = ({ movies, isLoading, onMovieSelect }) => {
  if (isLoading) {
    return (
      <div className="w-full max-w-screen-xl mt-8 text-center text-neutral-400">
  ...
  return (
    <div className="w-full max-w-screen-xl mt-8">
      <h2 className="text-2xl font-bold text-white mb-6 px-2 sm:px-0">Popular Movies</h2>
